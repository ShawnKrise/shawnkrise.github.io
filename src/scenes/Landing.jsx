  ...
  return (
    ...
    >
      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            className="relative z-0 ml-20 before:absolute before:-top-20 before:-left-20 before:rounded-t-[300px] before:rounded-b-[300px]
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <h1 className="text-6xl font-Roboto z-10 text-center md:text-start">Hey, I'm Shawn Krise. </h1>

          <h1 className="text-6xl font-Roboto z-10 text-center md:text-start">
              <span>
              <Typewriter
                 options={{
                 strings: ['A Marketer', 'A Graphic Designer', 'A Programmer'],
                autoStart: true,
                 loop: true,
              }}
              />
        ...
        >
          <AnchorLink
            className="bg-yellow text-deep-blue rounded-sm py-3 px-7 font-bold
